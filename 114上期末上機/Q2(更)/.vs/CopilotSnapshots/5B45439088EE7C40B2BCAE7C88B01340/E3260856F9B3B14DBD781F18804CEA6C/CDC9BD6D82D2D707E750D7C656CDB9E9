...
namespace Q2_更_
{
    public partial class Form1 : Form
    {
        ...
        // Handler wired in Designer for parts textbox; ensure method exists to avoid compile error.
        private void textBoxParts_TextChanged(object sender, EventArgs e)
        {
            // Optional: keep input simple; actual validation occurs on Calculate
        }
